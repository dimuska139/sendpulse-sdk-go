...
type CreateViberCampaignParams struct {
	...
	SentDate        models.DateTimeType `json:"sent_date"`
...
type ViberCampaign struct {
	...
	Created         models.DateTimeType `json:"created"`
}

func (service *ViberService) Campaigns(limit, offset int) ([]*ViberCampaign, error) {
...
type ViberRecipient struct {
	...
	LastUpdate    models.DateTimeType `json:"last_update"`
}
